    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-screen-xl w-full min-w-[95vw] max-h-[95vh] h-[90vh] p-0 flex flex-col">
        <DialogHeader className="px-6 pt-6 pb-4 shrink-0 w-full">
          ...
          <DialogDescription>
            View and manage all outstanding invoices and payments
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader className="border-b shrink-0 bg-emerald-50/70 p-6">
                  ...
                  <CardDescription>
                    Total amount pending across all invoices
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="border-b shrink-0 bg-emerald-50/70 p-6">
                  <CardTitle className="text-lg font-semibold text-emerald-900">Outstanding Invoices</CardTitle>
                  <CardDescription>
                    Complete list of all outstanding invoices with payment options
                  </CardDescription>
                </CardHeader>
                <CardContent>
