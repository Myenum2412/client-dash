  ...
  try {
    ...
    const [
      ...
      supabase
        ...
        .or(`project_number.ilike.${searchTerm},project_name.ilike.${searchTerm},contractor_name.ilike.${searchTerm}`)
        .limit(5),
      ...
      supabase
        ...
        .or(`dwg.ilike.${searchTerm},description.ilike.${searchTerm}`)
        .limit(5),
      ...
      supabase
        ...
        .or(`invoice_id.ilike.${searchTerm},project_number.ilike.${searchTerm},project_name.ilike.${searchTerm}`)
        .limit(5),
      ...
      supabase
        ...
        .or(`drawing_number.ilike.${searchTerm},work_description.ilike.${searchTerm}`)
        .limit(5),
      ...
      supabase
        ...
        .or(`change_order_id.ilike.${searchTerm},drawing_no.ilike.${searchTerm}`)
        .limit(5),
